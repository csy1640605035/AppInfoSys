...
public class AppVersionServiceImpl implements AppVersionService {
	...
	@Override
	public boolean deleteVersionByAppId(Integer id) {
		// TODO Auto-generated method stubboolean flag = false;
		boolean flag = false;
		if(mapper.deleteVersionByAppId(id)>0) 
		{
			flag=true;
		}
		return flag;
	...
	@Override
	public int getAppVersionByAppId(Integer id) {
		// TODO Auto-generated method stub
		int result=mapper.getAppVersionByAppId(id);
		return result;
	}
}
